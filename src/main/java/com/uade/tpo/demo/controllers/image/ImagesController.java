...
public class ImagesController {
    ...
    @PostMapping()
    public String addImagesPost(@RequestParam("archivos") List<MultipartFile> archivos) throws IOException, SerialException, SQLException {
        ...
        for (MultipartFile archivo : archivos) {
            ...
            if (!archivo.isEmpty()) {
                ...
                // 3. Al guardar en el servicio, la base de datos genera un ID único para esta imagen
